...
class DrinkSuggestionsScreen extends StatelessWidget {
  final List<Map<String, dynamic>> drinks = [
    {'name': 'Mojito', 'thành phần': ['Bạc hà', 'Chanh xanh', 'Rượu rum']},
    {'name': 'Espresso Martini', 'thành phần': ['Espresso', 'Vodka']},
    {'name': 'Green Tea Smoothie', 'thành phần': ['Trà xanh', 'Honey', 'Milk']},
  ];
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return ListTile(
            ...
            subtitle: Text('Ingredients: ${drinks[index]['ingredients'].join(', ')}'),
            onTap: () {
